# Remap Manifest — mycelium-sec → sec
...
|---|---|---|---|---|---|---|
| `sec.bin.myc-sec` | Keep | Safe | false | true | `/root/git/isolated/mycelium/crates/mycelium-sec/src/bin/myc-sec.rs` | structure-preserving 1:1 (DN-109 §5.3-B v0 default: every emitted nodule keeps its source file's mod-tree position, no restructuring proposed) |
| `sec` | Keep | Safe | false | true | `/root/git/isolated/mycelium/crates/mycelium-sec/src/lib.rs` | structure-preserving 1:1 (DN-109 §5.3-B v0 default: every emitted nodule keeps its source file's mod-tree position, no restructuring proposed) |
